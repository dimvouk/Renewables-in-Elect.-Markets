...
prob = 1/400 # Probability of each scenario
...
@objective(Step_1_2, Max,
            ...
            + 0.9 * unseen_scenarios[t, 1, s] * balance_up[t, s] * unseen_scenarios[t, 3, s]
            + 1 * unseen_scenarios[t, 1, s] * balance_up[t, s] * (1-unseen_scenarios[t, 3, s])
            - 1 * unseen_scenarios[t, 1, s] * balance_down[t, s] * unseen_scenarios[t, 3, s]
            - 1.3 * unseen_scenarios[t, 1, s] * balance_down[t, s] * (1-unseen_scenarios[t, 3, s])
            for s = 1:S) for t = 1:T)))
...
if termination_status(Step_1_2) == MOI.OPTIMAL
    ...
    for s = 1:S
        ...
        (unseen_scenarios[t, 1, s] * p_DA_opt_1_2[t] 
        + 0.9 * unseen_scenarios[t, 1, s] * value.(balance_up[t, s]) * unseen_scenarios[t, 3, s]
        + 1 * unseen_scenarios[t, 1, s] * value.(balance_up[t, s]) * (1-unseen_scenarios[t, 3, s])
        - 1 * unseen_scenarios[t, 1, s] * value.(balance_down[t, s]) * unseen_scenarios[t, 3, s]
        - 1.2 * unseen_scenarios[t, 1, s] * value.(balance_down[t, s]) * (1-unseen_scenarios[t, 3, s])
        for t = 1:T))
    end
    ...
    for s = 1:S
        ...
        + 1 * unseen_scenarios[t, 1, s] * value.(balance_up[t, s]) * (1-unseen_scenarios[t, 3, s])
        - 1 * unseen_scenarios[t, 1, s] * value.(balance_down[t, s]) * unseen_scenarios[t, 3, s]
        - 1.3 * unseen_scenarios[t, 1, s] * value.(balance_down[t, s]) * (1-unseen_scenarios[t, 3, s])
        for t = 1:T))
    end
    ...
    for s = 1:S
        profit_DA_1_2[s] = sum(prob * (unseen_scenarios[t, 1, s] * p_DA_opt_1_2[t]) for t = 1:T)
    end
